...
//  ExampleDemo
//
//  Created by xiejiangbo on 2018/4/12.
...
class FaceRecognitionViewController: BaseViewController ,AVCaptureVideoDataOutputSampleBufferDelegate{
    ...
    class func createViewController(createArgs:AnyObject?) ->AnyObject{
        let storyboard:UIStoryboard=UIStoryboard(name: "FaceRecognitionViewController", bundle: nil)
        let vc:FaceRecognitionViewController=storyboard.instantiateViewController(withIdentifier: "FaceRecognitionViewController") as! FaceRecognitionViewController
    ...
    func captureOutput(_ output: AVCaptureOutput!, didOutputSampleBuffer sampleBuffer: CMSampleBuffer!, from connection: AVCaptureConnection!) {
        ...
        if(self.isStart)
        {
            ...
            DispatchQueue.main.async {
                ...
                self.smallPicture.image = resultImage

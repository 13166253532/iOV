...
//  ExampleDemo
//
//  Created by xiejiangbo on 2018/1/11.
//  Copyright © 2018年 yin chen. All rights reserved.
//

import UIKit
import CoreMotion
class SmallBallViewController: BaseViewController {

    var manager = CMMotionManager()
    var ballView : STBallView?
    
    class func createViewController(createArgs:AnyObject?) ->AnyObject{
        let storyboard:UIStoryboard=UIStoryboard(name: "SmallBallViewController", bundle: nil)
        let vc:SmallBallViewController=storyboard.instantiateViewController(withIdentifier: "SmallBallViewController") as! SmallBallViewController

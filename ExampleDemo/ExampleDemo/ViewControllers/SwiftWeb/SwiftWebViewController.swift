...
class SwiftWebViewController: BaseViewController,WKUIDelegate,WKNavigationDelegate,WKScriptMessageHandler,UIGestureRecognizerDelegate {
    ...
    class func createViewController(createArgs:AnyObject?) ->AnyObject{
        let storyboard:UIStoryboard=UIStoryboard(name: "SwiftWebViewController", bundle: nil)
        let vc:SwiftWebViewController=storyboard.instantiateViewController(withIdentifier: "SwiftWebViewController") as! SwiftWebViewController
...
//    }
    ...
    var _wkWebV: WKWebView {
        ...
        configWkWeb.userContentController.add(self, name: "AppLogout")
        ...
        wkWebV.scrollView.bounces = false
        wkWebV.scrollView.isScrollEnabled = false
        wkWebV.allowsBackForwardNavigationGestures = true
        wkWebV.isMultipleTouchEnabled = true
        //下拉刷新
        if Device_System >= 10.0 && canDownRefresh {

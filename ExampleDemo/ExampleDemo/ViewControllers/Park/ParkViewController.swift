...
class ParkViewController: BaseViewController {
    ...
    class func createViewController(createArgs:AnyObject?) ->AnyObject{
        let storyboard:UIStoryboard=UIStoryboard(name: "ParkViewController", bundle: nil)
        let vc:ParkViewController=storyboard.instantiateViewController(withIdentifier: "ParkViewController") as! ParkViewController
